...
$sql3 = "INSERT INTO PersonalInfo(Names,DOB,Email,ContactNo,AdhaarNo,Add_Id,Gender) VALUES ('$name','$dob','$email','$num','$adhaar','". $row['MAX(Add_Id)'] ."','$gender')";
$sql4 = "SELECT MAX(Info_Id) FROM PersonalInfo ";
$sql5 = "INSERT INTO Volunteer(Info_Id,Image) VALUES ('".$row['MAX(Info_Id)']."','$img')";
