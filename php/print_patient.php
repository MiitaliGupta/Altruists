...
<head>
    <title>Altruists | Employer Table</title>
    <meta charset="utf-8">
                    ...
                    <div class="form-group">
                        <table style="border: 1px solid white; width: 100%;" cellpadding="13">
                            ...
                            <?php
                                    ...
                                    $sql1 = "SELECT Patient_Id,Home_Id, Names,AdhaarNo,DOB,Height,Weight,BMI,BloodGroup,Haemoglobin,SugarLevel,CholestrolLevel,MemNames, Email, ContactNo, Add_Id FROM Patient;";
