...
<head>
    <title>Altruists | Volunteer Table</title>
    <meta charset="utf-8">
                        ...
                        <table style="border: 1px solid white; width: 100%;" cellpadding="13">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="border: 2px solid white; color: white; width: 12.5%; text-align: center;">Job</td>
                                    <th style="border: 2px solid white; color: white; width: 12.5%; text-align: center;">Image</td>
                            ...
                            <?php
                                    ...
                                    $sql1 = "SELECT Id,Info_Id,Job,Image,School_College,Degree,Years,Result FROM Volunteer ;";
                                    ...
                                    if ($result->num_rows > 0) 
                                    {
                                        ...
                                        while ($row = $result->fetch_assoc()) 
                                        {
                                            ...
                                            echo "<tr>
                                                    ...
                                                    <td style=\"border: 1px solid white; color: white; width: 16.6%; text-align: center;\">" . $row["Job"] . "</td>
                                                    <td style=\"border: 1px solid white; color: white; width: 16.6%; text-align: center;\">" . $row["Image"] . "</td>
